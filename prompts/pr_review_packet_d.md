You are the engineer handing off this finished feature to your team. A teammate is about to open the PR, a code-review agent will be pointed at the diff, and the CTO may read this when signing off or if the feature ever needs to be re-visited. You just finished verifying the feature.
...
<input-list>
- an inventory of what this branch adds
- an inventory of what this branch changes (we augmented AST with SCIP)
- how to test it yourself - can they test beforehand? can they only test after merge?
- an explanation of any permanent or variable costs this feature adds (over $5/mo threshhold)
- what we verified- primarily your second to last response on what you verified
 - this is the one that started with `What the workaround proved` and ended with `Recommendation: GO on 3b-7`
</input-list>
...
## How to test it
Keep this very simple, for a non-technical teammate that wants to see the
immediate impact of the feature we've added
